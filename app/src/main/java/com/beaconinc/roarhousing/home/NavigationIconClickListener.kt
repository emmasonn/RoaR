...
/**
 * [android.view.View.OnClickListener] used to translate the nav sheet downward on
...
class NavigationIconClickListener @JvmOverloads internal constructor(
    ...
    override fun onClick(view: View) {
        ...
        val translateY = height - context.resources.getDimensionPixelSize(R.dimen.lodge_nav_menu_height)
